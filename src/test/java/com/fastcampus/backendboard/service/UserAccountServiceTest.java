...
class UserAccountServiceTest {
    ...
    void givenUserParams_whenSaving_thenSavesUserAccount() {
        // Given
        UserAccount userAccount = createUserAccount("kej");
        UserAccount savedUserAccount = createSigningUpUserAccount("kej");
        ...
        assertThat(result)
                ...
                .hasFieldOrPropertyWithValue("userPw", userAccount.getUserPw())
                ...
                .hasFieldOrPropertyWithValue("createdId", userAccount.getUserId())
                .hasFieldOrPropertyWithValue("modifiedId", userAccount.getUserId());
